...
fit_to_data_module <- function(input, output, session) {
  ...
  observeEvent(input$model_fit1, {
    ...
    "The fitted rates of F0 to F1 for current and former are 0.060 and 0.091","<br>",
    "Compared to the literature estimated rates of 0.106 and 0.116","<br>",
    "Note in the parameter database, there is no value for probability of transmission (estimated as 9.1%)","<br>",
  ...
  observeEvent(input$model_fit2, {
    ...
    "The fitted rates of F0 to F1 for current and former are 0.097 and 0.062","<br>",
    "Compared to the literature estimated rates of 0.106 and 0.116","<br>",
    "The fitted rates of relapse rate, injecting career duration are 0.082 and 15.35 years","<br>",
    "Compared to the literature estimated rates of 0.027 and 17 years","<br>",
    "Note in the parameter database, there is no value for probability of transmission (estimated as 7.2%)","<br>",
     "GENERALLY AT LEAST ONE PARAMETER IS USED TO CALIBRATE THE MODEL TO KNOWN EPIDEMIC DATA"
    ))})
